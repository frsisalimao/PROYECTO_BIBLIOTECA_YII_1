...
class UnidadTransporteController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('UnidadTransporte');
	...
	{
		$model=UnidadTransporte::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param UnidadTransporte $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='unidad-transporte-form')
		{
