...
class Compra extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idcompra, usuario_idusuario', 'required'),
			array('idcompra, usuario_idusuario', 'numerical', 'integerOnly'=>true),
			array('fecha, hora, total, estado', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idcompra, fecha, hora, total, estado, usuario_idusuario', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'boletos' => array(self::HAS_MANY, 'Boleto', 'compra_idcompra'),
